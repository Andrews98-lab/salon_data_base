...
MAIN_MENU(){
  ...
  case $OPTION_SELECTED in
    1) APPOINTMENT_MENU $OPTION_SELECTED;;
    2) APPOINTMENT_MENU $OPTION_SELECTED;;
    3) APPOINTMENT_MENU $OPTION_SELECTED;;
    4) APPOINTMENT_MENU $OPTION_SELECTED;;
    5) APPOINTMENT_MENU $OPTION_SELECTED;;
    6) EXIT ;;
